                    ...
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            <div class="validator-img">
                                ...
                                <img v-else src="https://ideachaincoin.com/wp-content/uploads/elementor/thumbs/logo-p1zcid2ww1p9ule2pgf04s43e4aj4mjvb7lyne9qak.png" alt="fantom logo" class="not-fluid">
                            </div>
                        </div>
                    </div>
                    <template v-else>
