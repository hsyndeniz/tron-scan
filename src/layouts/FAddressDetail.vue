            ...
            <div class="col margin-bottom-menu">
                <f-card>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="trxAccount">
                                {{ trxAccount.balance/1000000 }} <span class="ftm">ICH</span>
                            </span>
                        </h3>
                    </div>
                </f-card>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="'available' in cAssets">
                                <f-t-m-token-value :value="cAssets.available" convert no-currency /> <span class="ftm">ICH</span>
                            </span>
                        </h3>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            tronWeb.trx.getAccount(this.id).then(acc => {
                    console.log(acc);
                    console.log(acc.balance);
                    console.log(acc.balance/1000000);
                    this.trxAccount = acc;
                    console.log(this.trxAccount);
                }).catch(err => console.error(err));

            /**
            axios.post(`${api}/wallet/getaccount`, { address: "41E552F6487585C2B58BC2C9BB4492BC1F17132CD0" })
                .then(account => {
                    console.log("account");
                    console.log(account);
                    axios.post(`${api}/wallet/getaccountnet`, { address: "41E552F6487585C2B58BC2C9BB4492BC1F17132CD0" })
                        .then(accountNet => {
                            console.log("accountNet");
                            console.log(accountNet);
                            axios.post(`${api}/wallet/getaccountresource`, { address: "41E552F6487585C2B58BC2C9BB4492BC1F17132CD0" })
                                .then(accountResource => {
                                console.log("accountResource");
                                console.log(accountResource);
                                    axios.post(`${api}/wallet/getaccountbalance`, { address: "41E552F6487585C2B58BC2C9BB4492BC1F17132CD0" })
                                        .then(accountBalance => {
